...
env.roledefs = {
    'myserver': ['thephoenix@49.232.115.226'],
}
env.PROJECT_NAME = 'typeidea'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'

env.DEPLOY_PATH = '/home/thephoenix/venvs/typeidea-env'
env.VENV_ACTIVATE = os.path.join(env.DEPLOY_PATH, 'bin', 'activate')
env.PYPI_HOST = '49.232.115.226'
env.PYPI_INDEX = 'http://49.232.115.226:18080/simple'
env.PROCESS_COUNT = 2
env.PORT_PREFIX = 909
